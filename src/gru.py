...
# # Define GRU Model with Entity Embeddings
# class GRU(nn.Module):
...
#         self.gru = nn.GRU(input_size + embedding_dim, hidden_layer_size, num_layers=1, bidirectional=False)
...
# model = GRU(input_size, hidden_layer_size, output_size, dropout_prob, num_entities, embedding_dim)
