...
# # Define LSTM Model with Entity Embeddings
...
#     self.lstm = nn.LSTM(input_size + embedding_dim, hidden_layer_size, num_layers=1, bidirectional=False)
...
# model = LSTMModel(input_size, hidden_layer_size, output_size, dropout_prob, num_entities, embedding_dim)
